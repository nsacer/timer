...
public class GesturePassword extends View {
    ...
    private int colorLineError = 0xffe94b4b;

    /**
     * 选中状态的内圈、外圈颜色
     * */
    private int selectedColor = 0xff333333;
    private int outterSelectedColor = 0xff333333;
    /**
     * 密码错误状态内圈、外圈的颜色
     */
    private int errorColor = 0xffe94b4b;
    private int outterErrorColor = 0xffe94b4b;
    /**
     * 正常状态的内圈、外圈颜色
     * */
    private int dotColor = 0xff333333;
    private int outterDotColor = 0xff333333;
    /**
     * 手势密码输入完成监听
     */
