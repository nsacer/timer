...
public class ExplosionField extends View implements Animator.AnimatorListener{
    ...
    public interface OnAnimationEndListener{
        ...
        void onBangAnimationEnd(Animator animation);
    }
    ...
    public void onAnimationEnd(Animator animation) {
        ...
        if(mOnAnimationEndListener != null)
            mOnAnimationEndListener.onBangAnimationEnd(animation);
    }
